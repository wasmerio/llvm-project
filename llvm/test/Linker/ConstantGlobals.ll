...
; RUN: llvm-link --context-each-input %s %S/Inputs/ConstantGlobals.ll -S | FileCheck %s
; RUN: llvm-link --context-each-input %S/Inputs/ConstantGlobals.ll %s -S | FileCheck %s

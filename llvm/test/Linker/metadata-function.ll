...
; RUN: llvm-link --context-each-input %s %S/Inputs/metadata-function.ll -S | FileCheck %s
; RUN: llvm-link --context-each-input %S/Inputs/metadata-function.ll %s -S | FileCheck %s
